...
type OptionalOmit<T, K extends keyof any> = Pick<T, Exclude<keyof T, K>> & Partial<Pick<T, Extract<keyof T, K>>>;
...
export interface Model<Data, Key, DefaultFields extends keyof any = ''> {
    ...
    batchGet(keys: Key[], settings: ModelBatchGetSettings & {
        return: 'items';
    }, callback: CallbackType<ModelBatchGetItemsResponse<Item<Data>>, any>): void;
    batchGet(keys: Key[], settings: ModelBatchGetSettings & {
        return: 'request';
    ...
    batchPut(items: OptionalOmit<Data, DefaultFields>[], callback: CallbackType<UnprocessedItems<Item<Data>>, any>): void;
    batchPut(items: OptionalOmit<Data, DefaultFields>[], settings: ModelBatchPutSettings & {
        return: 'request';
    ...
    batchPut(items: OptionalOmit<Data, DefaultFields>[], settings: ModelBatchPutSettings & {
        return: 'response';
    }, callback: CallbackType<UnprocessedItems<Item<Data>>, any>): void;
    ...
    batchDelete(keys: Key[], settings: ModelBatchDeleteSettings & {
        return: 'response';
    }, callback: CallbackType<UnprocessedItems<Key>, any>): Promise<UnprocessedItems<Key>>;
    batchDelete(keys: Key[], settings: ModelBatchDeleteSettings & {
        return: 'request';
    ...
    update(keyObj: Key, updateObj: UpdatePartial<Data>, callback: CallbackType<Item<Data>, any>): void;
    update(keyObj: Key, updateObj: UpdatePartial<Data>, settings: ModelUpdateSettings & {
        return: 'item';
    }): Promise<Item<Data>>;
    update(keyObj: Key, updateObj: UpdatePartial<Data>, settings: ModelUpdateSettings & {
        return: 'item';
    }, callback: CallbackType<Item<Data>, any>): void;
    update(keyObj: Key, updateObj: UpdatePartial<Data>, settings: ModelUpdateSettings & {
        return: 'request';
    ...
    create(item: OptionalOmit<Data, DefaultFields>, settings: ItemSaveSettings & {
        return: 'request';
...
export interface CreateTransaction<Data> {
    ...
    (item: Partial<Data>, settings: ItemSaveSettings & {
        return: 'request';
